import { createUnit, fr, red, createText } from 'jc-color'

// 例1：同一个文本单元对象的多次打印
createUnit("你好 JC Color ！", "#FF0000", "blue", {
    reverse: true, // 颜色反转
    italic:true,   // 斜体
}).print()
...
import { geadientText } from 'jc-color'

let g1 = geadientText(
    "wlkejfhjkalwkerjfvSRT.6H54GSR.T23YH4hgohl",
    ["red", "blue",],
)


let g2 = geadientText(
    "arfdokwefkwsidjSRT3H564231fcghsdksjdhrfgjksfdhgjkf",
    ["red", "blue"],
    ["#43F5C0", "rgb(141,171,157)"],
)
...
// createUnit('6',{red:92.72727272727272,green:0,blue:162.27272727272728}).print()